...
/** Created by Daniel Lin on 2019/3/28. */
public class YearlyReportViewModel extends ReportViewModel {

  private LiveData<List<GroupedActionsItem>> mGroupedActionList =
      Transformations.map(
          Transformations.switchMap(
              mSelectedDate, (selectedDate) -> mDataRepository.getFinishedActions(mSelectedYear)),
          (actions) -> {
  ...
  public void selectDate(int year, int month, int day) {
    String newSelectedDate = String.format(Locale.getDefault(), "%d", year);
